...
router.route("/:id/latestscore").get((req, res, next) => {
...
router.route("/:id/rollingweek").get((req, res, next) => {
...
router.route("/:id/rollingmonth").get((req, res, next) => {
...
router.route("/:id/lastaudits").get((req, res, next) => {
...
router.route("/:id/audit/:date").get((req, res, next) => {
  elastic.query(
    "audit",
    {
      id: req.params.id,
...
router.route("/:id/audits").get((req, res, next) => {
